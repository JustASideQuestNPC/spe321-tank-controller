...
typedef enum {
    ...
    FLAG_WINDOW_ALWAYS_RUN  = 0x00000100,   // Set to allow windows isRunning while minimized
...
RLAPI const char *GetApplicationDirectory(void);                  // Get the directory of the isRunning application (uses static string)
